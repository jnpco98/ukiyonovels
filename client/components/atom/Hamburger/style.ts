...
export const SpeedRunner = styled.div<{ active: boolean }>`
  ${Base};
...
export const NoEntry = styled.div<{ active: boolean }>`
  ${Base};
...
export const Spread = styled.div<{ active: boolean }>`
  ${Base};
...
export const Tear = styled.div<{ active: boolean }>`
  ${Base};

...
export const fetchNovelsPaginatedAsync = createAsyncAction(
  '@novel/FETCH_PAGINATED_REQUEST',
  '@novel/FETCH_PAGINATED_SUCCESS',
  '@novel/FETCH_PAGINATED_FAILURE',
  '@novel/FETCH_PAGINATED_CANCEL'
)<{ query: BaseQuery }, Novel[], Error>();

export const searchNovelsAsync = createAsyncAction(
  '@novel/SEARCH_REQUEST',
  '@novel/SEARCH_SUCCESS',
  '@novel/SEARCH_FAILURE',
  '@novel/SEARCH_CANCEL'
...
export const updateNovelAsync = createAsyncAction(
  '@novel/UPDATE_REQUEST',
  '@novel/UPDATE_SUCCESS',
  '@novel/UPDATE_FAILURE',
  '@novel/UPDATE_CANCEL'
)<{ novel: Novel }, Novel, Error>();

export const deleteNovelAsync = createAsyncAction(
  '@novel/DELETE_REQUEST',
  '@novel/DELETE_SUCCESS',
  '@novel/DELETE_FAILURE, @novel/DELETE_CANCEL'
)<{ id: string }, Novel, Error>();
